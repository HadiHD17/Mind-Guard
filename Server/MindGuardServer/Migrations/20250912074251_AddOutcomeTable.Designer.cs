...
namespace MindGuardServer.Migrations
{
    ...
    [Migration("20250912074251_AddOutcomeTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MindGuardServer.Models.Domain.Outcome", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MindGuardServer.Models.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 12, 7, 42, 50, 879, DateTimeKind.Utc).AddTicks(2578),
                            Email = "hadi@gmail.com",
                            FullName = "Hadi Haidar",
                            IsDark = true,
                            Password = "AQAAAAIAAYagAAAAEKb/OAPzAgRCPNNCVjfyAGGckDOIvOPsw/BstIb9pWc2tpaW1HDrwXjqR366DowNQA==",
                            PhoneNumber = "81918422",
                            UpdatedAt = new DateTime(2025, 9, 12, 7, 42, 50, 879, DateTimeKind.Utc).AddTicks(2589)
                        });
                });
            ...
            modelBuilder.Entity("MindGuardServer.Models.Domain.Outcome", b =>
                {
                    b.HasOne("MindGuardServer.Models.Domain.Journal_Entry", "Entry")
                        .WithMany()
